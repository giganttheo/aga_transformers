...
def main():
    ...
    state = TrainState.create(apply_fn=apply_fn_with_graph, params=lora_params, tx=optimizer, dropout_rng=dropout_rng) # previously params=model.params, apply_fn=model.__call__

...
repo_path= "gigant/longt5-0322" #"gigant/longt5-global-3epoch" #"gigant/graph-t5-global-window-8k-longt5local" # ==> my checkpoint
...
with open('predictions_long.txt', 'w') as fp:
    for line in predictions:
        # write each item on a new line
        fp.write(line + "\n")
# open file in write mode
with open('references_long.txt', 'w') as fp:

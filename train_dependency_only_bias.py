...
from aga_transformers.models.t5.t5 import load_t5, load_efficient_t5, load_t5_from_pretrained
...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        tokenizer, model, graph, graph_ar = load_t5_from_pretrained(repo_path=model_args.model_name_or_path, dtype="bfloat16", attention_kwargs=attention_kwargs)
...
# from aga_transformers.models.utils import add_graph_to_params, repeat_relative_pos_bias
# from aga_transformers.models.t5.t5 import load_t5, load_efficient_t5, load_augmented_t5, load_t5_from_pretrained
...
#         }
#         print(attention_kwargs)
#         tokenizer, model, graph, graph_ar = load_t5_from_pretrained(repo_path=model_args.model_name_or_path, dtype="bfloat16", attention_kwargs=attention_kwargs, from_longt5_local=False, layer_wise=False)
#         graph = graph["encoder"]["block"]["0"]["layer"]["0"]["SelfAttention"]
...
#             graph = {"receivers": receivers, "senders": senders, "edge_labels": edge_labels}
#             graphs = graph_from_path(state.params, graph, {}, {}, layer_wise=False)
...
#         senders = batch.pop("senders")
#         edge_labels = batch.pop("edge_labels")
#         graph_dep = {"receivers": receivers, "senders": senders, "edge_labels": edge_labels}
#         graphs = graph_from_path(state.params, graph_dep, {}, {}, layer_wise=False)
#         loss, _ = loss_fn(model=state.apply_fn, params=params, graph=graph, graph_dependency=graphs, train=False, **batch)

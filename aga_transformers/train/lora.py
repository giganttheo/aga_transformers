...
def create_lora(model, optimizer, dtype="bfloat16"):
    ...
    frozen_params, tunable_params = lorax.init_lora(param_tree=model.params, spec=lora_spec, rng=jax.random.PRNGKey(0), dtype=dtype)

    lora_params = (frozen_params, tunable_params)

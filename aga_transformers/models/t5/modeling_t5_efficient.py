...
class FlaxT5BlockCollection(nn.Module):
    ...
    def __call__(
        ...
        if self.scan:
            ...
            layer_outputs, _ = nn.scan(remat(ScannableFlaxT5LayerCollection, static_argnums=(1, 2, 3, 4, 5, 6), policy=jax.checkpoint_policies.offload_dot_with_no_batch_dims), #remat(FlaxT5LayerCollection, static_argnums=(6, 7, 8)),

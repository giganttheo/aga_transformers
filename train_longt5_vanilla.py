...
from aga_transformers.models.t5.t5 import load_vanilla_longt5
...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        tokenizer, model = load_vanilla_longt5(repo_path=model_args.model_name_or_path, dtype="bfloat16")
